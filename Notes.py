...
#  rm"filename", rm -rf
# code"filename", mv--rename or move--, mv file1 name, --mv filename  ./relativepath, mv filename .. 
# cp Copy folderpath
...
# ------------------ range(staring num, ending num+1, Step Argument) --range function, --for i in string_name or variable_name:
